...
on your own machine instead of depending on cloud services. The current local
model setup uses Qwen2.5-1.5B-Instruct-GGUF, while the project overall focuses
on private, local usage and an assistant experience that feels capable,
